					...
					if (tempBod.m_type !== 'static' && tempBod.isAwake()) {
						...
						if (entity) {
							...
							if (ige.isServer) {
								...
								if (ige.game.config.clientSidePredictionEnabled && entity.clientStreamedPosition) {
								...
								if (ige.physics && ige.game.config.clientSidePredictionEnabled && ige.client.selectedUnit == entity) {
